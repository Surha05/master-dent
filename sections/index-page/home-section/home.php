<div class="home" id="home">
	<div id="js_home_background" class="home_slider_background" style="background-image:url(images/home_background_1.jpg)"></div>
		<div class="home_content">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_content_inner">
										<div class="home_title"><h1 id="js_home_title">Medicine made with care</h1></div>
										<div class="home_text">
