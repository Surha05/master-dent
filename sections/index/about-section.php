			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-7">
					<div class="about_content">
						<div class="section_title"><h2 id="js_about_title">A great medical team to help your needs</h2></div>
				...
				<!-- About Image -->
				<div class="col-lg-5">
					<div class="about_image"><img src="images/about.png" alt="" id="js_about_img"></div>
				</div>
			</div>
		</div>
	</div>