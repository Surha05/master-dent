...
<div class="tes-modal">
	<div class="tes-modal__container">
		<input class="tes-modal__input" placeholder="Имя">
		<textarea class="tes-modal__textarea" placeholder="Отзыв"></textarea>
		<label for="tes-input-file" class="tes-modal__label">Фото</label>
		<input type="file" id="tes-input-file" >
		<button class="tes-modal__btn">Отправить</button>
		<div class="tes-modal__close"></div>
	</div>
</div>

<script src="/sections/about-page/testimonials-section/modal.js"></script>
