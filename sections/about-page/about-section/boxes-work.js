(function () {
  ...
  let whatsappBlock = document.querySelector('#work-whatsapp');
  let instagramBlock = document.querySelector('#work-instagram');
  let envelopeBlock = document.querySelector('#work-envelope');
