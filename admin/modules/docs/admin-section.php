<section class="section dashboard" id="docs-section">
   <div class="row">
            ...
            <div class="card-body pb-0">
               <div class="header-card-body">
                  ...
                  <div class="header-left-card-block">
                     <h5 class="card-title" id="add-btn" data-bs-toggle="modal" data-bs-target="#add-docs-modal">+ Добавить документ</h5>
                  </div>
...
<?php
include '../../modules/docs/add-modal.php';
?>

<script src="/admin/modules/docs/render.js" type="module"></script>
<script src="/admin/modules/docs/add.js"></script>
<script src="/admin/modules/docs/del.js"></script>