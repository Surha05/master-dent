import { products } from '../../../API/advantage/get.js';
  ...
  function render(arr) {
    ...
    for (const item of arr) {
      ...
      <div class="admin-list__item p-5" id="${item.id}">
        <div class="w-100"><img src="/images/advantage/${item.photo}" class="w100"></div>
        <div class="w-200 fw-bold" id="data-name">${item.name}</div>
        <div class="w-300 fw-bold" id="data-description">${item.description}</div>
        <div class="ml-auto"><a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
            <li><a id="btn-edit-advantage" class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#edit-advantage-modal">Редактировать</a></li>
            <li><a id="btn-del-advantage" class="dropdown-item" href="">Удалить</a></li>
          </ul>
        </div>
      </div>`;
